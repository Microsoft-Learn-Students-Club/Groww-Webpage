  ...
  return (
    <div className=" bg-columbia-blue border-2 p-8 rounded-lg max-w-3xl mx-auto mt-10">
      ...
      <form className="space-y-4">
        ...
        <button type="submit" className="w-full bg-indigo-dye shadow-lg shadow-cerulean text-white font-semibold py-2 rounded-lg hover:bg-cerulean transition duration-300">Submit Feedback</button>
      </form>
    </div>
  );
}
